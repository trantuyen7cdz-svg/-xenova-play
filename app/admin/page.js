...
export default function AdminPage() {
  ...
  async function saveProduct(event) {
    ...
    if (editingId) {
      ...
      if (error) {
        setMessage("Không cập nhật được: " + error.message);
        return;
      }
      ...
      if (error) {
        setMessage("Không thêm được sản phẩm: " + error.message);
        return;
      }
  ...
  async function toggleProduct(product) {
    ...
    if (error) {
      setMessage("Không thay đổi được trạng thái: " + error.message);
      return;
    }
  ...
  async function deleteProduct(product) {
    ...
    if (error) {
      setMessage("Không thể xóa sản phẩm: " + error.message);
      return;
    }
    ...
    <main className={styles.adminPage}>
      <div className={styles.adminContainer}>
        ...
        >
          ...
          <p className={styles.sectionText}>
            Phần duyệt đơn hàng và cấp KEY sẽ được
            kết nối tiếp theo.
          </p>
