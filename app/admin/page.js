...
export default function AdminPage() {
  ...
  async function createProduct() {
    ...
    try {
      ...
      const keyRows = keys.map((keyCode) => ({
        key_code: keyCode,
      ...
      if (keyError) {
        ...
        // Nếu tạo sản phẩm thành công nhưng
        // thêm KEY thất bại thì xóa sản phẩm vừa tạo
        await supabase
          .from("products")
          .delete()
          .eq("id", product.id);
